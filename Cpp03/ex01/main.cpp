...
int main(void)
{
	...
	///////////////test de creacion de obejtos dinamicos// Atrves de punteros sobre los que se reserva memeria 
	...
	///////////miembro compartido //a traves de punteros en el argumento de las funciones
